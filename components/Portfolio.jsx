...
<Image 
  ...
  <img style={imgStyle} src='/chptr1/Page 25.png' alt="Page" />  <p className="py-6"></p>

  <img style={imgStyle} src='/chptr1/Page 26.png' alt="Page" />
  <p className="py-6"></p>

  <img style={imgStyle} src='/chptr1/Page 27.png' alt="Page" />  <p className="py-6"></p>

  <img style={imgStyle} src='/chptr1/Page 28.png' alt="Page" />  <p className="py-6"></p>

  <img style={imgStyle} src='/chptr1/Page 29.png' alt="Page" />  <p className="py-8"></p>

  <img style={imgStyle} src='/chptr1/Page 30.png' alt="Page" />
  <p className="py-4"></p>

  <img style={imgStyle} src='/chptr1/Page 31.png' alt="Page" />  <p className="py-6"></p>
  ...
  <img style={imgStyle} src='/chptr1/Page 36.png' alt="Page" />  <p className="py-7"></p>

  <img style={imgStyle} src='/chptr1/Page 37.png' alt="Page" />  <p className="py-4"></p>

  <img style={imgStyle} src='/chptr1/Page 38.png' alt="Page" />  <p className="py-5"></p>
  ...
  <img style={imgStyle} src='/chptr1/Page 47.png' alt="Page" />  <p className="py-4"></p>

  <img style={imgStyle} src='/chptr1/Page 48.png' alt="Page" />  <p className="py-4"></p>

  <img style={imgStyle} src='/chptr1/Page 49.png' alt="Page" />
  <p className="py-7"></p>

  <img style={imgStyle} src='/chptr1/Page 50.png' alt="Page" />
  <img style={imgStyle} src='/chptr1/Page 51.png' alt="Page" />  <p className="py-4"></p>
